...
let para = "Flo 🌹" ; // valor por defecto
let mensaje = `Hola, niña linda. 
Sé que hoy es un día especial para ti
...
en desde hace cuánto te conozco
y se me olvida lo poco que 
llevamos hablando,porque 
se siente como si siempre 
hubieras estado ahí,
como si te conociera 
de toda una vida.

Me dijiste que crees en el destino,
entonces quizás sí,
quizás sí fue el destino
que esperó el momento adecuado
para hacernos coincidir
de una manera no tan común,
pero bonita, y si es así 
...
let loadingText = "Para ti Flo"; // valor por defecto para loading
